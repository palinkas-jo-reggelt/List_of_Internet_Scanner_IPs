# List_of_Internet_Scanner_IPs
 List of comma separated Internet Scanner IPs by 0/24 range intended as firewall rule for blocking scanners.
 
 There are currently ***3,420*** IP ranges on the list.
